...
const MARKETING_PAGES: Record<Language, Record<MarketingPageKey, MarketingPageContent>> = {
  de: {
    ...
    comparisons: {
      ...
      description:
        "Wenn du einfach nur tracken willst, kommen meist dieselben Fragen auf: Muss ich monatlich zahlen? Liegen die guten Funktionen hinter Premium? Kommt noch Gamification, Coaching oder eine Account-Plattform dazu? Genau dabei helfen diese Vergleiche.",
      sections: [
        {
          id: "hub",
          title: "Was Nutzer bei Trackern wirklich vergleichen",
          body:
            "Nicht die Marketing-Slogans sind entscheidend, sondern ob du für Nährwerte, Widgets, Fasten, Rezepte oder bessere Auswertungen dauerhaft zahlen musst und ob die App ruhig bleibt oder ständig zusätzliche Motivationsebenen über dein Tracking legt.",
          bullets: ["Abo-Modell und Premium-Wall", "Kontosystem oder lokaler Ansatz", "Ruhe statt Gamification", "Wie viel wirklich in der Basis-App steckt"],
          screenshot: "dashboard",
        },
        {
          id: "intake",
          title: "Wofür Intake bewusst nicht gebaut ist",
          body:
            "Intake will keine Ernährungs-Coach-Plattform sein. Die App verzichtet bewusst auf Streaks, Punkte, unnötige Tipps und andere Mechaniken, die eher Aufmerksamkeit binden als gutes Tracking ermöglichen.",
...
const COMPARISON_PAGES: Record<Language, Record<ComparisonSlug, ComparisonPageContent>> = {
  de: {
    "yazio-alternative": {
      ...
      description:
        "Yazio ist stark auf Pro-Abos, Coaching und zusätzliche Motivationsebenen ausgerichtet. Intake ist die ruhigere Alternative für Leute, die einfach tracken wollen, ohne monatlich für Kernfunktionen zu zahlen.",
      criteria: [
        {
          label: "Geschäftsmodell",
          intake: "Einmalkauf. Die App ist nicht um eine wiederkehrende Abo-Conversion herum gebaut.",
          other: "Yazio arbeitet klar mit Pro-Abos. Viele der beworbenen Komfort- und Analysefunktionen sind Teil von Yazio Pro.",
        },
        {
          label: "Was in der Basis-App steckt",
          intake: "30+ Nährwerte, Widgets, Apple Watch, PDF-Export, Rezepte, Fasten und Personalisierung gehören zur normalen App.",
          other: "Bei Yazio liegen wichtige Extras wie detaillierte Nährwerte, Smart Food Rating oder Meal Planning hinter Pro.",
        },
        {
          label: "Produktstil",
          intake: "Ruhiger Tracker ohne Streaks, Badges, Gamification oder ungefragte Ernährungstipps.",
          other: "Yazio ist stärker als Coach- und Habit-Produkt inszeniert, inklusive Motivations- und Guidance-Layer.",
        },
        {
          label: "Kontosystem und Datenmodell",
          intake: "Es gibt gar kein Konto. Daten bleiben lokal und syncen nur optional.",
          other: "Yazio kann auf iOS zwar ohne Signup starten, das Produkt bleibt aber ein service- und Abo-zentrierter Dienst mit Cloud-/Account-Logik im Hintergrund.",
        },
        {
          label: "Ziele und Steuerung",
          intake: "Eigene Kalorien- und Makroziele, wissenschaftlich basierte Auto-Berechnung, wiederkehrende Tagesanpassungen und einstellbare Aktivitätsanrechnung.",
          other: "Yazio bietet ebenfalls Ziel- und Planungsfunktionen, setzt aber stärker auf Planungs-, Coaching- und Pro-Features als auf feingranulare Tracker-Steuerung.",
        },
        {
          label: "Apple- und Geräte-Integration",
          intake: "Apple Watch App, Komplikationen, Homescreen- und Lockscreen-Widgets sowie Live Activities sind Teil des Produkts.",
          other: "Yazio deckt Apple-Geräte ebenfalls ab, wirkt aber stärker als Service rund um Tracking und Motivation als als anpassbare Apple-native Utility.",
        },
        {
          label: "Für wen es besser passt",
          intake: "Wenn du einfach essen tracken und auswerten willst, ohne Monatsabo und ohne Coaching-Layer.",
          other: "Wenn du genau diese Coaching-, AI- und Habit-Funktionen suchst und ein Pro-Abo okay findest.",
        },
      ],
      conclusion:
        "Wenn dir ein ruhiger Kalorientracker ohne Abo, ohne Streak-Mechanik und ohne Kontosystem wichtiger ist als Coaching- und Habit-Features, ist Intake die klarere Alternative zu Yazio.",
      takeaways: [
        "Intake packt Kernfunktionen wie Nährwerte, Widgets, Rezepte und Export nicht hinter ein Monatsabo.",
        "Yazio ist stärker als Coach- und Pro-Produkt aufgebaut, Intake stärker als ruhige Utility-App.",
        "Wenn du Streaks, Gamification und zusätzliche Ernährungstipps nicht willst, wirkt Intake deutlich fokussierter.",
      ],
    },
    "fddb-alternative": {
      ...
      description:
        "FDDB ist näher an einem Portal mit Web-Sync, Premium-Abo und breiter Plattformlogik. Intake ist die fokussiertere Alternative, wenn du lokal tracken und wichtige Funktionen nicht erst freischalten willst.",
      criteria: [
        {
          label: "Geschäftsmodell",
        ...
        {
          label: "Konto- und Plattformlogik",
          intake: "Kein Konto, kein Web-Portal, keine Registrierung. Daten bleiben lokal mit optionalem Sync.",
          other: "FDDB ist Teil eines Portal-/Web-Modells und synchronisiert Tagebuchdaten in Echtzeit zwischen App und Website.",
        },
        {
          label: "Was in der App enthalten ist",
          intake: "30+ Nährwerte, Widgets, Fasten, Wasser, Rezepte, PDF-Export, eigene Ziele, Apple Watch und Personalisierung sind direkt Teil des Produkts.",
          other: "Bei FDDB hängen mehrere Funktionen wie Fasten, Widgets, Tracker-Verbindungen, Planner und weitere Komfortfunktionen am Premium-Abo.",
        },
        {
          label: "Produktstil",
          intake: "Fokussierte App, die sich wie eine ruhige Tracking-Utility anfühlt.",
          other: "FDDB wirkt stärker wie eine Plattform mit App, Website, Premium-Bereich und zusätzlicher Feature-Logik darum herum.",
        },
        {
          label: "Ziele und Steuerung",
          ...
          other: "FDDB bietet ebenfalls Planner- und Zielsysteme, aber ein Teil dieser Steuerung ist stärker an Premium und Plattformfunktionen gebunden.",
        },
        {
          ...
          other: "FDDB unterstützt Fitness-Tracker und Health-Apps, positioniert diese Anbindungen aber stärker im Premium-Umfeld.",
        },
        {
          label: "Für wen es besser passt",
          intake: "Wenn du eine moderne, lokale App willst, die schnell ist und keinen Account-Overhead mitbringt.",
          other: "Wenn du bewusst ein Portal mit Web-Sync, Premium-Abo und größerem Plattform-Kontext suchst.",
        },
      ],
      conclusion:
        "Wenn du keinen account-zentrierten Tracker mit Premium-Abo suchst, sondern eine fokussierte App mit lokaler Datenhaltung und starken Funktionen direkt im Produkt, ist Intake die modernere FDDB-Alternative.",
      takeaways: [
        "FDDB ist stärker auf App plus Web-Portal plus Premium-Mitgliedschaft ausgelegt, Intake nicht.",
        "Intake bleibt lokal und ruhig, statt zusätzlich eine Plattformlogik um dein Tracking herum aufzubauen.",
        "Wenn du wichtige Funktionen lieber direkt in der App hast als in einem Premium-Abo, ist Intake die klarere Richtung.",
      ],
    },
  },
  en: {
