...
- One of your own products opened for editing and then submitted for review was treated like a catalogue product: the "This product has no barcode" button was missing, and if sending failed, your edit was lost. The button is there now, and the edit is kept locally either way.
