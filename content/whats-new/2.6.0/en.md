...
title: "What's new in Intake 2.6.0"
summary: "Recipes becomes Library, adding food is rethought, and spoons, cups and glasses join grams"
coverImage: "./assets/cover.svg"
highlights:
  - Favourites, your own products, recipes, routines and submissions in one tab, with a search across all of it
  - Your own tags and sorting for every list
  - Suggestions for the exact meal you are logging
  - Routines log a whole breakfast in one tap
  - One camera for barcodes and Meal Scan, full screen
  - Search sits at the bottom, where your thumb is
  - Teaspoons, tablespoons, cups, glasses and millilitres for any food
---
...
![add food](assets/add-food-en.png)
